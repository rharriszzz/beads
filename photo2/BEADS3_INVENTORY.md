...
R073–R075 follow-up: [neighborhood geometry, HSV measurements and mask calibration](BLACK_REGION_METHODS.md)
examines 122/405 without changing this inventory. The calibration measures
transfer among provisional masks only; physical centers and the two warning
regions remain unresolved. Next work resumes with the beads4 JPEG-only review.
